...
public class EmployeeController {
    ...
    @ApiOperation("员工状态转换")
    public Result<Object> staSwitch(@PathVariable int status, Long id) {
        log.info("员工{}状态被修改为{}", id, status);
        employeeService.staSwitch(status, id);
        return Result.success();
    }
    ...
    @ApiOperation("修改员工密码")
    public Result<Object> delete(@RequestBody PasswordEditDTO passwordEditDTO) {
        log.info("将id为{}的密码修改为****", passwordEditDTO.getEmpId());
